...
const Header = () => {
    ...
    return (
        <>
            <div className='w-full bg-[#005A2F] text-white text-center uppercase p-5 rounded-b-[40px] Montserrat text-sm sm:text-2xl'>
            ...
            <div className={`fixed top-0 left-0 h-full w-64 bg-white z-50 shadow-lg transform transition-transform duration-300 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} lg:hidden`}>
                ...
                <div className="flex flex-col gap-5 uppercase text-lg font-bold p-5 text-[#005A2F]">
                    ...
                    <button onClick={() => setIsMenuOpen(false)} className='w-40 h-10 lg:w-64 lg:h-12 text-white uppercase rounded-full bg-[#86AF35] text-sm sm:text-2xl'>
                        start your order
                    </button>
                </div>
            </div>
            ...
            <div className="w-full max-w-[1340px] mx-auto px-5 flex justify-between items-center mt-5">
                ...
                <div className="text-3xl lg:text-5xl font-bold text-[#005A2F] font-[LilitaOne] uppercase">
                    L<span className='text-secondary'>o</span>g<span className='text-secondary'>o</span>
                </div>
                <div className='hidden md:flex justify-between items-center gap-5'>
                    <button className='w-40 h-10 lg:w-64 lg:h-12 text-white uppercase  rounded-full bg-[#86AF35] text-sm sm:text-2xl '>
                        start your order
                    </button>
